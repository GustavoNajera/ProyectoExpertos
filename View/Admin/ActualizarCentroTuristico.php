...
<div class="typrography">
    <div class="container">
        <h3 class="tittle">Actualizar Centros Turísticos</h3>
        ...
        <div class="grid_3 grid_5 wow fadeInRight animated" data-wow-delay=".5s">
            ...
            <form action="#">
                ...
                <div class="col-md-6">
                    <input type="text" style="margin-bottom: 15px;" class="form-control" placeholder="Nombre" required="">
                    <input type="email" style="margin-bottom: 15px;" class="form-control" placeholder="Correo" required="">
                </div>
                <div class="col-md-6">
                    <input type="text" style="margin-bottom: 15px;" class="form-control" placeholder="Descripción" required="">
                    <input type="text" style="margin-bottom: 15px;" class="form-control" placeholder="Teléfono" required="">
                </div>
